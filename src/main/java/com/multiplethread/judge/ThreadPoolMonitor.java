...
public class ThreadPoolMonitor {
    ...
    public String getReport(ThreadPoolExecutor executor) {
        ...
        log.debug("Generating report: AvgExecTimeMillis={}, AvgWaitTimeMillis={}, Gamma={}, TaskCount={}",
